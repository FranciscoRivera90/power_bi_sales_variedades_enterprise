...
Este proyecto, es un prototipo empresarial, que presenta un dashboard interactivo en Power BI desarrollado para Variedades Enterprise, una empresa dedicada a la venta minorista.
